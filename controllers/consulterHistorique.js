...
//     }else{
//       console.error('existe déja un status dans cette saison veteran')
//     }
//   }
...
//       }else{
//         console.error('existe déja un status dans cette saison choriste')
//       }
//     }
...
//       }
//       else{
//         console.error('existe déja un status dans cette saison senior')
//       }
//     }
...
//     if (!candidat) {
//       return res.status(404).json({ message: 'Candidat non trouvé pour ce choriste' });
//     }
//     await updateStatus(choristeId, candidat.createdAt);

//     // Retourner les détails du profil, le statut actuel et l'historique des statuts
//     res.json({
//       profil: {
//         _id: candidat._id,
//         nom: candidat.nom,
//         prenom: candidat.prenom,
//         statutActuel: choriste.statutAcutel,
//         role: choriste.role,
//         dateNaissance: candidat.dateNaissance,
//         cin: candidat.cin,
//         telephone: candidat.telephone,
//         AnneeIntegration:candidat.createdAt.getFullYear(),
//         // Ajoutez d'autres champs du modèle Personne au besoin
//       },
//       //statutActuel: choriste.statutActuel,
